...
def load_gui(self):
    # adding all the lables to the input fields
    ...
    self.lbl_list = tk.Label(self.master,text = 'List of Students:')
    self.lbl_list.grid(row=0,column=2,padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    # adding buttons    
    self.btn_add = tk.Button(self.master,width=12,height=2,text='Submit',command=lambda: student_tracking_func.addToList(self))
    ...
    self.btn_close.grid(row=9,column=2,columnspan=1,padx=(15,0),pady=(45,10),sticky=E)
