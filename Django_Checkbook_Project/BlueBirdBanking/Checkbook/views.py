...
def home(request):
    ...
    if request.method == 'POST':
        pk = request.POST['account']  # If the form is submitted, retrieve wich account the user wants to view
...
def balance(request, pk):
    ...
    transactions = Transaction.Transactions.filter(account=pk)  # Retrieve all of the account's transactions
