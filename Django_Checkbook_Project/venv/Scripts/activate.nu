...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\spike\PycharmProjects\Django_Checkbook_Project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\spike\PycharmProjects\Django_Checkbook_Project\Scripts\deactivate.nu'
